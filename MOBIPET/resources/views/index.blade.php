  ...
  <body class="index-page">
      ...
      <main class="main">
                      ...
                      <div class="col-lg-6">
                          <div class="hero-content">
                              ...
                              <p class="hero-description text-dark fw-bold" data-aos="fade-right" data-aos-delay="400">
                                  Agende banho, tosa e consultas em segundos, <span class="laranja fw-bold"> e
                                      acompanhe tudo em tempo real pelo app.</span>
                              </p>

                              <div class="hero-stats mb-4" data-aos="fade-right" data-aos-delay="500">
                                  <div class="stat-item">
                                      <h3><span data-purecounter-start="0" data-purecounter-end="100"
                                              data-purecounter-duration="2.5" class="purecounter"></span>+</h3>
                                      <p>Funcionaidades</p>
                                  </div>
                                  <div class="stat-item">
                                      <h3><span data-purecounter-start="0" data-purecounter-end="6"
                                              data-purecounter-duration="2" class="purecounter"></span></h3>
                                      <p>Desenvolvedores</p>
                                  </div>
                                  <div class="stat-item">
                                      <h3><span data-purecounter-start="0" data-purecounter-end="2"
                                              data-purecounter-duration="1.4" class="purecounter"></span></h3>
                                      <p>Anos de Experiência</p>
                                  </div>
                              </div>

                              <div class="hero-actions" data-aos="fade-right" data-aos-delay="600">
                                  <a href="{{ route('agendamento') }}" class="btn btn-primary">Agendar Agora <i
                          ...
                          <div class="hero-visual" data-aos="fade-left" data-aos-delay="400"
                              ...
                              <div class="main-image">
                                  <img src="{{ asset('assets/img/pet_sendo_cuidado.png') }}"
                                      alt="pet recebendo cuidados" class="img-chowchow">
          ...
          <style>
              ...
              /* .footer-bottom carrega um fundo azul fixo (estilo.css); ajusta o texto para contraste */
