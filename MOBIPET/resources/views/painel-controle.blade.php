...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Montserrat:wght@600;700&family=Lato:wght@400;700&display=swap"
        rel="stylesheet">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        @if (session()->has('id') && session('nivel_acesso') == 'USUARIO')
                            ...
                            <li><a href="{{ route('perfil') }}" class="active"><i class="fa-solid fa-user"></i></a>
                            </li>
            ...
            <div class="container">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-6">
                        ...
                        <a href="{{ route('services.create') }}" class="quick-action d-block text-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <a href="{{ route('logout') }}" class="quick-action d-block text-center">
