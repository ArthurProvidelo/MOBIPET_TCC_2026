...
<body class="index-page">
            ...
            <div class="container">
                ...
                <div class="hero-agendamento text-center" data-aos="fade-up">
                    ...
                    <p class="hero-subtitle">
                        Mantenha as informações do seu companheiro em dia para garantir a melhor experiência nos
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 text-metod">Altere os campos necessários nos blocos de informação
                                            abaixo.</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form action="{{ route('pets.update', $pet->id_pet) }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="nome" class="form-control"
                                            value="{{ $pet->nome }}" placeholder="Ex: Thor, Mel, Pipoca..."
                                            required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-6">
                                                <input type="radio" class="btn-check" name="especie"
                                                    id="especie_cao" value="Cão"
                                                    {{ $pet->especie == 'Cão' || $pet->especie == 'Cachorro' ? 'checked' : '' }}
                                                    required>
                                                <label
                                                    class="btn btn-outline-custom w-100 py-3 rounded-4 d-flex flex-column align-items-center gap-2"
                                                    for="especie_cao">
                                            ...
                                            <div class="col-6">
                                                <input type="radio" class="btn-check" name="especie"
                                                    id="especie_gato" value="Gato"
                                                    {{ $pet->especie == 'Gato' ? 'checked' : '' }}>
                                                <label
                                                    class="btn btn-outline-custom w-100 py-3 rounded-4 d-flex flex-column align-items-center gap-2"
                                                    for="especie_gato">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input type="text" name="raca" class="form-control"
                                                value="{{ $pet->raca }}" placeholder="Ex: Poodle, Vira-lata..."
                                                required>
                                        </div>

                                        <div class="col-md-6 mb-4">
                                            <label>Data de Nascimento <span
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="segmented-control p-1 rounded-4 d-flex" role="group">
                                            <input type="radio" class="btn-check" name="porte" id="porte_p"
                                                value="Pequeno" {{ $pet->porte == 'Pequeno' ? 'checked' : '' }}>
                                            <label class="btn segment-item w-100 py-3 fw-semibold rounded-3 small"
                                                for="porte_p">Pequeno</label>

                                            <input type="radio" class="btn-check" name="porte" id="porte_m"
                                                value="Médio" {{ $pet->porte == 'Médio' ? 'checked' : '' }}>
                                            <label class="btn segment-item w-100 py-3 fw-semibold rounded-3 small"
                                                for="porte_m">Médio</label>

                                            <input type="radio" class="btn-check" name="porte" id="porte_g"
                                                value="Grande" {{ $pet->porte == 'Grande' ? 'checked' : '' }}>
                                            <label class="btn segment-item w-100 py-3 fw-semibold rounded-3 small"
                                                for="porte_g">Grande</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 justify-content-between align-items-center">
                                        <div class="col-md-4 order-2 order-md-1">
                                            <a href="{{ route('pets.index') }}"
                                                class="btn-voltar d-flex align-items-center justify-content-center gap-2">
                                                Cancelar e voltar
                                            </a>
                                        </div>
  ...
  ========================================================= -->
    ...
    <script>
    console.log("SCRIPT DE ATUALIZAÇÃO FOI CARREGADO");
