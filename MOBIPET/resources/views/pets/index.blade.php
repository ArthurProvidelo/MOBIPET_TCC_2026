...
<body class="inner-page">
  ...
  <main class="main" style="margin-top: 120px;">
    ...
    <div class="container py-5" data-aos="fade-up" data-aos-delay="100">
        ...
        @if(session('success'))
            <div class="alert alert-success alert-dismissible fade show border-0 shadow-sm rounded-4 p-3 mb-4" role="alert" style="font-family: 'Roboto', sans-serif;">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0" style="font-family: 'Roboto', sans-serif;">
                        ...
                        <thead class="table-light" style="font-family: 'Montserrat', sans-serif; background-color: #f8f9fa;">
                            <tr>
                                <th class="py-3 px-4 text-secondary fw-semibold text-uppercase fs-7" style="letter-spacing: 0.5px;">Nome</th>
                                <th class="py-3 text-secondary fw-semibold text-uppercase fs-7" style="letter-spacing: 0.5px;">Espécie</th>
                                <th class="py-3 text-secondary fw-semibold text-uppercase fs-7" style="letter-spacing: 0.5px;">Raça</th>
                                <th class="py-3 text-secondary fw-semibold text-uppercase fs-7" style="letter-spacing: 0.5px;">Porte</th>
                                <th class="py-3 px-4 text-secondary fw-semibold text-uppercase fs-7 text-end" style="letter-spacing: 0.5px;">Ações</th>
                            </tr>
                        </thead>
                            ...
                            @forelse($pets as $pet)
                                <tr style="transition: background-color 0.2s ease;">
                                    ...
                                    <td class="py-3 text-muted">
                                        <span class="badge bg-light text-dark border px-2 py-1 rounded-pill fw-normal">{{ $pet->raca }}</span>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-5">
                                        ...
                                        <h5 class="fw-semibold text-secondary" style="font-family: 'Montserrat', sans-serif;">Nenhum pet por aqui</h5>
                                        <p class="text-muted small mb-0">Cadastre o seu primeiro pet clicando no botão "Novo Pet" acima.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
