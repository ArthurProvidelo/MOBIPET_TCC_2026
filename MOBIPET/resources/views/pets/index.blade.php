            ...
            <div class="container">
                ...
                <div class="hero-agendamento text-center" data-aos="fade-up">
                    ...
                    <p class="hero-subtitle">
                        Gerencie os dados dos seus pets cadastrados, acompanhe históricos ou adicione novos membros à
                        família.
                    </p>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('pets.create') }}"
                            class="btn btn-primary px-4 py-3 rounded-3 fw-bold shadow-sm"
                            style="transition: 0.3s; background: linear-gradient(135deg, #2563eb, #1d4ed8); border:none;">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 text-metod">
                                                Confira abaixo a listagem completa dos seus animais.
                                            </p>
                            ...
                            <div class="card-body p-0">
                                                ...
                                                @foreach ($pets as $pet)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td data-label="Espécie">
                                                            ...
                                                            <span
                                                                class="badge badge-especie px-3 py-2 rounded-pill fw-semibold">
                                                        ...
                                                        <td data-label="Porte">
                                                            ...
                                                            <span
                                                                class="badge bg-light text-dark border px-2.5 py-1.5 rounded-3 fw-semibold small">
                                                        ...
                                                        <td
                                                            ...
                                                            <div class="d-flex justify-content-end gap-2">
                                                                ...
                                                                <a href="{{ route('pets.edit', $pet->id_pet) }}"
                                                                    class="btn btn-action btn-edit-pet"
                                                                    title="Editar Pet">
                                                                ...
                                                                <!-- EXCLUIR -->
                                                                <form
                                                                    action="{{ route('pets.destroy', $pet->id_pet) }}"
                                                                    method="POST"
                                                                    ...
                                                                    <button type="submit"
                                                                        class="btn btn-action btn-delete-pet"
                                                                        title="Excluir Pet">
                                ...
                                @else
                                    ...
                                    <div class="text-center py-5 px-4">
                                        ...
                                        <p class="text-secondary mb-4 max-width-auto mx-auto"
                                            style="max-width: 450px;">

                                            Cadastre seu primeiro pet para poder agendar serviços de banho e tosa e
                                            acompanhar o status em tempo real.

                                        </p>

                                        <a href="{{ route('pets.create') }}"
                                            class="btn btn-primary px-4 py-2.5 rounded-3 fw-bold">
            ...
            <div class="footer-main py-5" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 d-flex flex-column align-items-start">
                        ...
                        <a href="{{ route('index') }}"
                            class="logo d-flex align-items-center mb-3">
